...
public class ProductConfiguration : IEntityTypeConfiguration<Products> {
    public void Configure(EntityTypeBuilder<Products> builder) {
        ...
        builder.HasOne(o => o.CategoryIDNavigation).WithMany(o => o.ProductsCategoryIDNavigations);
        builder.HasMany(o => o.Order_Details).WithOne(o => o.ProductIDNavigation);
        ...
        if (p.CategoryIDNavigation.ProductsCategoryIDNavigations[0].Order_Details.First().ProductIDNavigation == null)
