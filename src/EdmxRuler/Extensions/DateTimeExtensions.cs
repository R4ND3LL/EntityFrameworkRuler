...
internal static class DateTimeExtensions {
    ...
    /// uint startTime = 0;
    /// if (millisecondsTimeout != 0 && millisecondsTimeout != Timeout.Infinite) startTime = DateTimeExtensions.GetTime();
    /// if (millisecondsTimeout != Timeout.Infinite)
    ///     if (millisecondsTimeout &lt;= (DateTimeExtensions.GetTime() - startTime)) return false;
