...
public class DbContextExtensionsModelGenerator : RuledModelGeneratorBase, IRuledModelCodeGenerator {
    ...
    /// <summary> This is an internal API and is subject to change or removal without notice. </summary>
    public DbContextExtensionsModelGenerator(
    ...
    public IList<ScaffoldedFile> GenerateModel(ModelEx modelEx, ModelCodeGenerationOptions options) {
        ...
        if (contextTemplate.Exists) {
            ...
            var functionFileName = "DbContextExtensions" + host.Extension;
