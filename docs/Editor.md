...
**Now available as a [Visual Studio Extension](https://marketplace.visualstudio.com/items?itemName=Randell.EF-Ruler).**
...
1) Install the [Visual Studio Extension](https://marketplace.visualstudio.com/items?itemName=Randell.EF-Ruler), right click on an EDMX and go to _Convert EDMX to DB Context Rules_. ![EDMX Converter](../src/Resources/EdmxConverterPreview.png)
...
![Rule Editor](../src/Resources/RuleEditorPreview.png)
